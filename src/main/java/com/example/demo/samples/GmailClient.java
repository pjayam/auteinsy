...
public class GmailClient {
	...
	public void sendGmail(String from, String to, String subject, String text) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Sending email to: " + to + " failed !!!", "Falied to Send!!!",
		...
		try {
			...
			// sometimes Transport.send(simpleMessage); is used, but for gmail it's
			// different
	...
	public static void main(String[] args) {
		...
		String mailFrom = new String("pavanjayam87@gmail.com");

		// Sender must be a Gmail Account holder

		String mailTo = new String("pavanjayam87@gmail.com");
